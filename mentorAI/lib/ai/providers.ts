...
export const PROVIDERS: Record<ProviderId, ProviderConfig> = {
  openai: {
    ...
    requiresApiKey: true,
    icon: withBasePath('/logos/openai.svg'),
    models: [
      {
        id: 'gpt-5.2',
        name: 'GPT-5.2',
  ...
  anthropic: {
    ...
    icon: withBasePath('/logos/claude.svg'),
    models: [
      {
        id: 'claude-opus-4-6',
  ...
  google: {
    ...
    icon: withBasePath('/logos/gemini.svg'),
    models: [
      {
  ...
  glm: {
    ...
    requiresApiKey: true,
    icon: withBasePath('/logos/glm.svg'),
    models: [
  ...
  qwen: {
    ...
    requiresApiKey: true,
    icon: withBasePath('/logos/qwen.svg'),
    models: [
      {
        id: 'qwen3.5-flash',
        name: 'Qwen3.5 Flash',
  ...
  deepseek: {
    ...
    requiresApiKey: true,
    icon: withBasePath('/logos/deepseek.svg'),
    models: [
      {
        id: 'deepseek-chat',
        name: 'DeepSeek-Chat',
  ...
  kimi: {
    ...
    requiresApiKey: true,
    icon: withBasePath('/logos/kimi.png'),
    models: [
  ...
  minimax: {
    ...
    requiresApiKey: true,
    icon: withBasePath('/logos/minimax.svg'),
    models: [
      {
        id: 'MiniMax-M2.5',
        name: 'MiniMax M2.5',
  ...
  siliconflow: {
    ...
    requiresApiKey: true,
    icon: withBasePath('/logos/siliconflow.svg'),
    models: [
      // DeepSeek Series
      {
  ...
  doubao: {
    ...
    requiresApiKey: true,
    icon: withBasePath('/logos/doubao.svg'),
    models: [
      {

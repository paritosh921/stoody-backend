...
const IMAGE_PROVIDER_ICONS: Record<ImageProviderId, string> = {
  seedream: withBasePath('/logos/doubao.svg'),
  'qwen-image': withBasePath('/logos/bailian.svg'),
  'nano-banana': withBasePath('/logos/gemini.svg'),
};
...
const VIDEO_PROVIDER_ICONS: Record<VideoProviderId, string> = {
  seedance: withBasePath('/logos/doubao.svg'),
  kling: withBasePath('/logos/kling.svg'),
  veo: withBasePath('/logos/gemini.svg'),
  sora: withBasePath('/logos/openai.svg'),
};

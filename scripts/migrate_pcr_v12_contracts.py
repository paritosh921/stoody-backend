#!/usr/bin/env python3
"""Inspect or migrate PCR cohorts from whole-copy v12 to grounded v13.
...
restart them after the command completes so queued cohort jobs run on v13.
"""
...
CONFIRMATION_TOKEN = "MIGRATE_PCR_V12_TO_V13"


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Dry-run or apply a cohort-safe PCR v12 to v13 migration"
    )
    ...
    parser.add_argument(
        "--requested-by",
        default="operations:pcr-v12-v13-migration",
        help="Audit actor",
    )
    return parser

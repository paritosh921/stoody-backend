...
async def reprocess_processing_job(
    ...
    *,
    ...
    reset_fields: Dict[str, Any] = {
        ...
        "mapping_pipeline_version": mapping_pipeline_version,
        # An explicit reprocess is the Standard lane even when the original
        # submission was configured for Economy checking.
    ...
    reset = await jobs.update_one(
        reset_filter,
        {
            ...
            "$inc": {"reprocess_count": 1, "grading_generation": 1},

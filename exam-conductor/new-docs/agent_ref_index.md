...
| 4 | ExamPen Hub (edge) | `stoody-pen-multi/exam-hub/` (NEW — to be created) | Python 3.12, Textual TUI, SQLite, systemd | Dedicated Pi edge device. **NOT BUILT.** |

### Critical Folder Boundaries

- **`stoody-pen-multi/edge_hub/`** — This is the Stoody smartboard hub. **DO NOT modify it** for ExamPen work. ExamPen has its own hub at `stoody-pen-multi/exam-hub/`.
- **`stoody-pen-multi/mobile-app/`** — The invigilator mobile app will be extended for ExamPen (BLE commands to exam-hub). Shared between smartboard and ExamPen use cases.
...
7. **Never modify `stoody-pen-multi/edge_hub/`** — ExamPen hub code goes in `stoody-pen-multi/exam-hub/`.
...
| ExamPen hub (edge device) work | `integration/HUB_DEPLOYMENT_SPEC.md`, `hub/ble-gatt-spec.md`, `hub/ipc-protocol.md` — **code goes in `stoody-pen-multi/exam-hub/`, NOT `edge_hub/`** |

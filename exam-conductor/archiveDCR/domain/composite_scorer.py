...
from exampen.dcr.domain.text_similarity import compute_tfidf_similarity
from exampen.dcr.domain.structural_similarity import compute_structural_similarity
